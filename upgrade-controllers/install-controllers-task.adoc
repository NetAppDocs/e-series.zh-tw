...
.EF280 和 EF50 控制器型號
--
有關安裝新 EF80 和 EF50 控制器的資訊，請參閱 link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 和 EF80 - 步驟 7：安裝控制器"^]。
