...
.EF80 和 EF50 控制器型號
--
有關從 EF80 和 EF50 儲存系統移除控制器的資訊，請參閱 link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller["EF50 和 EF80 - 步驟 1：移除控制器"^]。
