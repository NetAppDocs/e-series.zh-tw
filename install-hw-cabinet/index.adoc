...
[role="lead"]
您可以在 E-Series 3040 40U 機櫃中安裝下列控制器磁碟機匣和擴充磁碟機匣。

如果您的控制器磁碟機匣或擴充磁碟機匣未列於下方，請參閱 https://hwu.netapp.com["NetApp Hardware Universe"^]以確認您的控制器磁碟機匣或擴充磁碟機匣是否受支援。
