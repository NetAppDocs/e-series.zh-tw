...
Unified Manager 是一款以 Web 為基礎的軟體，用於管理您的整個網域。透過集中式檢視，您可以查看所有新型 E 系列和 EF 系列陣列的狀態，例如 EF50、EF80、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C 和 EF600C。您也可以對選定的儲存陣列執行批次作業。
...
命令列介面 (CLI) 是一種軟體應用程式，可用於設定和監控儲存陣列。使用 CLI，您可以從作業系統提示字元執行命令，例如  `DOS C:` 提示字元、Linux 作業系統路徑或 Solaris 作業系統路徑。
