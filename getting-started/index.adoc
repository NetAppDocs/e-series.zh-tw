...
NOTE: 可能支援其他介面和作業系統。如需詳細資訊、請聯絡技術支援部門。
 ...
 a| 
本網站不包含軟體版本 11.50 或韌體版本 8.50 之前的版本資訊。如需了解更早版本的資訊，請前往 https://docs.netapp.com/us-en/e-series-santricity/early-versions.html#software-documentation-for-earlier-releases["E-Series 和 SANtricity 早期版本的文件"^]頁面。
