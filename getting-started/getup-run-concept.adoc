...
sidebar: sidebar 
keywords: E-Series, eseries, E2800, E5700, EF300, EF600, E4000, EF50, EF80 
...
若要安裝 E-Series 硬體，請存取適用於您的儲存陣列和機櫃類型（如適用）的安裝和設定說明：

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["EF50 或 EF80 儲存系統"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager 12.0x 版線上說明"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["SANtricity System Manager 11.9x 線上說明"^]
