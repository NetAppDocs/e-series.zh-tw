...
== Version 12.0R1 版本新增功能

此版本僅包含少量變更，沒有新功能。如需此版本變更的詳細資訊，請參閱 E-Series SANtricity OS 12.0R1 README。
...
[[new-features-in-version-11-90r6]]
== Version 11.90R6 版本新增功能
...
支援更新的 IOM/DCM 韌體版本
 a| 
現在以下 IOM/DCM 型號支援新的 IOM/DCM 韌體版本：
