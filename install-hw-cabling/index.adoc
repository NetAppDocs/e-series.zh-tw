...
NOTE: 如果您在下面的清單中沒有看到您的控制器機架（儲存系統），請查看 link:../getting-started/getup-run-concept.html["E系列的快速入門"^] 並點擊您特定儲存系統的連結以存取佈線資訊。
...
如果您要為以下任何配置進行佈線，請參閱  https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["將IOM磁碟機櫃新增至現有的E27XX、E56XX或EF560控制器機櫃。"^]
...
|===
有關支援鏡像功能的佈線資訊，請參閱 https://www.netapp.com/pdf.html?item=/media/17133-tr4656.pdf["同步與非同步鏡射功能說明與部署指南"^]。
