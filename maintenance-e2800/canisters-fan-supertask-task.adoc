...
+
.. 選取*硬體*。
.. 查看 * Shelf* 下拉式清單右側的風扇圖示、判斷哪個機櫃的風扇image:../media/sam1130_ss_hardware_fan_icon_maint-e2800.gif["風扇圖示"]箱故障。
+
如果某個元件故障、此圖示為紅色。
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_led_callout_maint-e2800.gif[風扇箱 LED]
...
. 按下橘色彈片以釋放風扇容器握把。
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e2800.gif[風扇罐釋放拉片]
...
. 使用風扇容器握把將風扇容器拉出機櫃。
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e2800.gif[風扇箱拉柄]
