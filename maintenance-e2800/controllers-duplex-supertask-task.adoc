...
+
... 選取*硬體*。
... 如果圖形顯示的是磁碟機，請選擇 *Show back of shelf* 以顯示控制器
... 選取您要離線的控制器。
...
+
image::../media/28_dwg_e2800_remove_battery_maint-e2800.gif[從控制器箱中取出電池]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[取下面板]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[從控制器卡上卸下 HIC]
...
+
image::../media/28_dwg_e2800_insert_battery_maint-e2800.gif[重新安裝電池]
...
+
image:../media/28_dwg_e2800_battery_flange_ok_maint-e2800.gif["正確的金屬凸緣"]

** *不正確*-電池的金屬法蘭未插入控制器的插槽：
+
image:../media/28_dwg_e2800_battery_flange_not_ok_maint-e2800.gif["金屬凸緣不正確"]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[在控制器上重新安裝 HIC]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[重新安裝面板]
...
+
image::../media/28_dwg_e2824_remove_controller_canister_maint-e2800.gif[重新安裝控制器箱]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif[重新安裝控制器箱]
