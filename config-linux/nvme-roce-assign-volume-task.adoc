...
---
= 使用 SANtricity 系統管理員指派磁碟區 - Linux （ NVMe over roce ）
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.步驟
. 從 SANtricity System Manager 介面的左側面板中，選取功能表：Storage[Hosts]。
...
.接下來呢？
指派磁碟區後，link:nvme-roce-display-volumes-visible-host-task.html["向主機顯示可見的磁碟區"]。
