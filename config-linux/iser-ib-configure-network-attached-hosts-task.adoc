...
. 在主機上啟用和啟動iSCSI服務：
+
*紅帽企業版 Linux 8、9 和 10（RHEL 8、RHEL 9 和 RHEL 10）*
...
----
+
*SUSE Linux Enterprise Server 12、15 與 16（SLES 12、SLES 15 與 SLES 16）*
...
iscsiadm -m session
----
.. 從儲存陣列檢查 iscsi 連線狀態。在 SANtricity System Manager 中，前往 *設定* > *系統* > *檢視/結束 iSCSI 連線*。
