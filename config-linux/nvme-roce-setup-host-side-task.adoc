...
.開始之前
您必須執行最新的相容 RHEL 8、RHEL 9、RHEL 10、SLES 12、SLES 15 或 SLES 16 服務包作業系統。參見 https://mysupport.netapp.com/matrix["NetApp 互通性對照表工具"^] 如需查看最新要求的完整清單。

.步驟
. 安裝RDMA和NVMe-CLI套件：
+
*SLES 12、SLES 15 或 SLES 16*
